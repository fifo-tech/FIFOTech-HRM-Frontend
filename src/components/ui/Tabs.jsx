  ...
  (
    ...
    return (
      <li
        ...
        className={cn(
          "text-title cursor-pointer disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50",
          className,
          {
            [cn("cursor-default", activeClassName)]: value === contextValue,
          },
        )}
