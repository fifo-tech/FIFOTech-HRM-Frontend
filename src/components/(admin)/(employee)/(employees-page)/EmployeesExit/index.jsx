    ...
    <div className="mx-4 my-6 min-h-screen">
      <div className="rounded-md bg-white p-6 shadow-md">
        ...
        <div className="mb-4 flex items-center justify-between">
          <h6 className="text-lg font-semibold">List All Employee Exit</h6>
          <div className="space-x-2">
            <button className="rounded bg-primary px-4 py-1 text-white hover:bg-indigo-600">
              <FontAwesomeIcon icon={faPlus} /> Exit Type
            </button>
            <button className="rounded bg-primary px-4 py-1 text-white hover:bg-indigo-600">
            ...
            <tbody>
              {paginatedData.map((item, index) => (
                ...
                >
                  <td className="relative px-4 py-2">
                    <div className="group relative flex h-[50px] items-center space-x-4">
                      ...
                      <div className="absolute inset-0 hidden items-center justify-center space-x-2 group-hover:flex">
                        ...
                        <Link
                          to={`/employee-exit/${index}/view`}
                          className="rounded bg-green-400 p-2 text-sm text-white hover:bg-green-600"
                          title="View"
                        >
                  ...
                  <td className="px-4 py-2">{item.exitType}</td>
                  <td className="px-4 py-2">{item.exitDate}</td>
                  <td className="px-4 py-2">{item.exitInterview}</td>
                  <td className="px-4 py-2">{item.disableAccount}</td>
                </tr>
              ))}
            </tbody>
          </table>
