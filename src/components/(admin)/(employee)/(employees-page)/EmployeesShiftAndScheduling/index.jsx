        ...
        <div className="overflow-x-auto p-4">
          <table className="min-w-full table-auto border-collapse">
            <thead className="bg-gray-100 text-sm">
              <tr>
                <th className="border-b border-t px-4 py-2 text-left">SHIFT</th>
            ...
            <tbody>
              {paginatedData.map((item, index) => (
                ...
                >
                  ...
                  <td className="max-w-40 px-4 py-2">{item.saturday}</td>
                  <td className="max-w-40 px-4 py-2">{item.sunday}</td>
                  <td className="max-w-40 px-4 py-2">{item.monday}</td>
                  <td className="max-w-40 px-4 py-2">{item.tuesday}</td>
                  <td className="max-w-20 px-4 py-2">{item.wednesday}</td>
                  <td className="max-w-40 px-4 py-2">{item.thursday}</td>
                  <td className="max-w-40 px-4 py-2">{item.friday}</td>
                </tr>
              ))}
            </tbody>
          </table>
