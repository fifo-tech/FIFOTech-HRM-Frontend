...
function AddEmployeeAttendanceCreateSection() {
    ...
    <section className="container mx-4 my-8 max-w-4xl rounded-lg bg-white shadow-md">
      <div className="rounded-md bg-white p-6">
        ...
        <div className="mb-4 flex items-center justify-between">
          ...
          <button className="rounded bg-primary px-4 py-1 text-white hover:bg-indigo-700">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="w-1/3 rounded-md bg-white p-6 shadow-md">
            ...
            <p className="mt-4 text-gray-700">
              Your attendance has been updated. Click "OK" to reset the form.
            </p>
            <div className="mt-6 flex justify-end">
              <button
                ...
                className="rounded bg-primary px-4 py-2 text-white hover:bg-indigo-700"
              >
                OK
              </button>
            </div>
...
export default AddEmployeeAttendanceCreateSection;
